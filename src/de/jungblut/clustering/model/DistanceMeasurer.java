...
public final class DistanceMeasurer {
  ...
  public static double measureManhattanDistance(ClusterCenter center, Vector v) {
    double sum = 0;
  ...
  public static double measureEuclidianDistance(ClusterCenter center, Vector v) {
    double sum = 0;
    int length = v.getVector().length;
    for (int i = 0; i < length; i++) {
