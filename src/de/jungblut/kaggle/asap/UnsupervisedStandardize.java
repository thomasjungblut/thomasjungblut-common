 ...
 */
public class UnsupervisedStandardize extends PotentialClassIgnorer implements
        UnsupervisedFilter, Sourcable {
        ...
        if (instance instanceof SparseInstance) {
            ...
            for (int j = 0; j < instance.numAttributes(); j++) {
                ...
                if (instance.attribute(j).isNumeric()
                    ...
                    if (!NAN_BEFORE && Double.isNaN(value)) {
...
//		    if (!NAN_BEFORE && Double.isNaN(vals[j])) {
//			throw new Exception("A NaN value was generated "
//				+ "while standardizing attribute "
//				+ instance.attribute(j).name());
//		    }
     ...
     * contained in a class with the given name (there may be auxiliary
     * classes), and will contain two methods with these signatures:
     * <p/>
     * <pre>
     * <code>
     * // converts one row
    ...
    public String toSource(String className, Instances data) throws Exception {
        ...
        for (i = 0; i < data.numAttributes(); i++) {
            process[i] = (data.attribute(i).isNumeric() && (i != data
                    .classIndex()));
        }
    ...
    public static void main(String[] argv) {
        runFilter(new UnsupervisedStandardize(), argv);
    }
}
