 ...
 * under the proxy of a {@link TreeNode}. <br/>
...
public final class TreeCompiler implements Opcodes {
   ...
   * @return a new compiled {@link TreeNode}.
   */
  public static TreeNode compileAndLoad(String name, TreeNode node)
      throws Exception {
   ...
   * @return a new {@link TreeNode}.
   */
  public static TreeNode load(String name, byte[] byteCode) throws Exception {
    Class<TreeNode> loadClass = loadClass(byteCode, name);
   ...
   */
  public static byte[] compileNode(String name, TreeNode root) throws Exception {
    ClassWriter cw = new ClassWriter(ClassWriter.COMPUTE_MAXS);
    MethodVisitor mv;
    cw.visit(Opcodes.V1_6, ACC_PUBLIC + ACC_FINAL, name, null,
        Type.getInternalName(Object.class),
        new String[] { Type.getInternalName(TreeNode.class) });
    ...
    // add the constructor
    {
      ...
      mv.visitMethodInsn(INVOKESPECIAL, Type.getInternalName(Object.class),
          "<init>", "()" + Type.VOID_TYPE.getReturnType());
      mv.visitInsn(RETURN);
      mv.visitMaxs(1, 1);
      mv.visitEnd();
    }
    ...
    {
      mv = cw.visitMethod(ACC_PUBLIC, "predict", Type
          .getMethodDescriptor(TreeNode.class.getDeclaredMethod("predict",
              DoubleVector.class)), null, null);
      Label end = new Label();
    ...
    {
      mv = cw.visitMethod(ACC_PUBLIC, "transformToByteCode", Type
          .getMethodDescriptor(TreeNode.class.getDeclaredMethod(
