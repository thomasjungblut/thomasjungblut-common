...
public class StrassenMatrixMultiplication {
	 ...
	 * of two.
	 */
	public static final void checkInput(double[][] a, double[][] b) {
		int n = a.length;
		if (!isPowerOfTwo(n)) {
	 ...
	 */
	public static final double[][] reconstructMatrix(double[][] r,
	 ...
	 */
	public static final void copyBack(double[][] destination, double[][] r,
			int x, int y) {
		for (int i = 0; i < r.length; i++) {
			for (int j = 0; j < r.length; j++) {
				destination[x + i][y + j] = r[i][j];
			}
		}
	}
	 ...
	 * Copy method.
	 */
	public static final double[][] copy(final int num, double[][] source,
			int x, int y) {
	 ...
	 */
	private static final double[][] strassen(double[][] inputA,
			double[][] inputB) {
		int n = inputA.length;
		if (n == 1) {
	 ...
	 */
	public static final double[][] add(double[][] a, double[][] b, int signOfb) {
		int n = a.length;
	 ...
	 * is no power of two.
	 */
	public static final boolean isPowerOfTwo(int length) {
	 ...
	 */
	public static final void printMatrix(double[][] x) {
